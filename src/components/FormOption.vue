...
<template>
    ...
    <div class="flex flex-row justify-center items-center">
        <button
            v-bind:class="{
                optionQuestionSelected: numberOfChoice == 1,
                optionQuestion: numberOfChoice != 1,
            }"
            @click="numberOfChoice = 1"
        >
        ...
        <button
            v-bind:class="{
                optionQuestionSelected: numberOfChoice == 2,
                optionQuestion: numberOfChoice != 2,
            }"
            @click="numberOfChoice = 2"
        >
        ...
        <button
            v-bind:class="{
                optionQuestionSelected: numberOfChoice == 3,
                optionQuestion: numberOfChoice != 3,
            }"
            @click="numberOfChoice = 3"
        >
    ...
    <div v-for="n of numberOfChoice" :key="n" class="">
        ...
        <input
            type="text"
            class="text-sky-500 text-center p-1 border-2 border-gray-400 rounded-lg"
            v-model="answers[n - 1]"
        />
